...
public class ProximityOnWakePreferenceController extends TogglePreferenceController {
    ...
    public boolean isChecked() {
        return Settings.System.getInt(mContext.getContentResolver(), PROXIMITY_ON_WAKE, 0) == 1;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return Settings.System.putInt(mContext.getContentResolver(), PROXIMITY_ON_WAKE, isChecked ? 1 : 0);
    }
